...
layui.define(['layer', 'form', 'code'], function (exports) {
    ...
    var setIframe = function (editor, textArea, set) {
                    ...
                    , image: function (range) {
                        ...
                        layui.use('upload', function (upload) {
                            ...
                            upload.render({
                                ...
                                , exts: uploadImage.exts || 'jpg|png|gif|bmp|jpeg|pdf'
        ...
        , tools = {
            ...
            ,
            colorpicker: '<i class="layui-icon layedit-tool-colorpicker" title="字体颜色选择" id="layFontColor_Index">&#xe66a;</i>'
            ,
            ...
            ,
            attachment: '<i class="layui-icon layedit-tool-attachment" title="插入附件" layedit-event="attachment" style="font-size:18px">&#xe62f;<input type="file" name="file"></i>'
            ,
